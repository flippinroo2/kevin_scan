...
export type blockProps = { endBlock?: number, genesisBlock?: number, lastBlock?: number, lastFinalizedBlock?: number, startBlock?: number }
...
export type polkadotState = { polkadotReducers?: polkadotProps }
